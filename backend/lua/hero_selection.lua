...
local tableRadiantHeroes = { 
    {"npc_dota_hero_" .. radHero1,  LANE_TOP},
    {"npc_dota_hero_" .. radHero2,  LANE_TOP},
    {"npc_dota_hero_" .. radHero3,  LANE_TOP},
    {"npc_dota_hero_" .. radHero4,  LANE_TOP},
    {"npc_dota_hero_" .. radHero5,  LANE_TOP},
};
